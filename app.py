...
<p style="margin-top:25px; font-size:14px; font-weight:bold;">
  ...
  <a href="mailto:josh@b2bstartupandgrowthexpo.com" style="color:#D7262F; font-weight:bold;">josh@b2bstartupandgrowthexpo.com</a><br/>
  (+44) 2034517166
</p>
...
def send_email(sender_email, sender_password, row, subject, custom_html):
    try:
        server = smtplib.SMTP("mail.b2bstartupandgrowthexpo.com", 587)
        server.starttls()
        ...
        try:
            imap = imaplib.IMAP4_SSL("mail.b2bstartupandgrowthexpo.com")
...
sender_email = st.text_input("Sender Email", value="josh@b2bstartupandgrowthexpo.com")
